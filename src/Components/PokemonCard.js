...
const rerender=()=>{
  ...
  return (
    ...
    <div className="container-fluid d-inline-flex" onClick={()=>{setmodalStatus(true)}}>

{modalStatus && <CustomizedDialogs 
                    rerender={rerender}
                    name={name}
                    imgsrc={imgsrc}
                    stats={stats}
...
<div className="card mb-3 pokbody" >
        <div className="row g-0" >
          ...
          <div className="col-7 container"> 
            <div className="card-body">
              ...
              <h3>{name}</h3>
               {typepok.map((val)=>{
                return(
                  <p className="poktype"><i>{val.type.name}</i></p>
                )
              })}
          ...
          <div className="col-5 pokimg">
            <img src={imgsrc} className="img-fluid rounded-start" alt={props.name} />
          </div>
